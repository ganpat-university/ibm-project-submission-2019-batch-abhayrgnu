...
$firstname_err = $last_name_err = $pincode_err = $email_err = $userPassword_err = $confirmPassword_err = '';
$first_name = '';
$last_name = '';
$pincode = '';
$email = '';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows != 0) {
        ...
        if (!preg_match("/^[1-9]{1}[0-9]{5}$/", $pincode)) {
            $pincode_err = "Pincode must not start with 0.\nPincode must be of 6 digits only.\nThe Last five digits of pincode can in range of 0-9";
            $data_validation = 0;
            // echo $pincode_err;
        } else {
            $data_validation = 1;
        ...
        <div class="form_container">
            <form name="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form_wrap">
                    <div class="form_item">
                        <label>Pincode</label>
                        <input type="text" value="<?php echo (isset($pincode) ? $pincode : ''); ?>" name="pincode">
                        <div class="error" id="pincode"><?php echo $pincode_err; ?></div>
                    </div>
                </div>
                <div class="form_wrap">
                    <div class="form_item">
